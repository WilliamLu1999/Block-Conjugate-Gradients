...
plt.plot(iteration_pcg_2,log_pcg_2,label =('PCG-1',pcg_kappa_2))
plt.legend()
...
plt.plot(iteration_pcg_3,log_pcg_3,label =('PCG-1000',pcg_kappa_3))
plt.legend()
plt.show()
###############################################################
...
plt.plot(iteration_pcg_4,log_pcg_4,label =('PCG-0',pcg_kappa_4))
plt.legend()
plt.show()
...
plt.plot(iteration_pcg_5,log_pcg_5,label =('PCG-1',pcg_kappa_5))
plt.legend()
...
plt.plot(iteration_pcg_6,log_pcg_6,label =('PCG-1000',pcg_kappa_6))
plt.legend()
plt.show()